...
This project is indexed by GitNexus as **editecc** (334 symbols, 405 relationships, 3 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
