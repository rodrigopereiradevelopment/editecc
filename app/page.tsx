    ...
    <>
      ...
      <nav style={{
        ...
        <div style={{ marginLeft: "auto", display: "flex", gap: "8px", alignItems: "center" }}>
          ...
          <a href="https://github.com/rodrigopereiradevelopment/editecc/releases/tag/v1.0.0" target="_blank" rel="noopener noreferrer" className="cta-primary" style={{ padding: "7px 16px", fontSize: "13px" }}>
            Baixar Grátis
          </a>
        </div>
      </nav>
          ...
          <div style={{
            ...
            <div style={{ flex: "1 1 400px", maxWidth: "580px" }}>
              ...
              <div style={{
                ...
                <a href="https://github.com/rodrigopereiradevelopment/editecc/releases/tag/v1.0.0" target="_blank" rel="noopener noreferrer" className="cta-primary">
                  Baixar grátis
                </a>
          ...
          <div style={{ maxWidth: "800px", margin: "0 auto" }}>
            <div style={{
              ...
              <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap", marginBottom: "12px" }}>
                <a href="https://github.com/rodrigopereiradevelopment/editecc/releases/download/v1.0.0/EditeCC_0.9.14_x64-setup.exe" target="_blank" rel="noopener noreferrer" className="cta-primary">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
                  Windows
                </a>
                <a href="https://github.com/rodrigopereiradevelopment/editecc/releases/download/v1.0.0/EditeCC_0.9.14_amd64.deb" target="_blank" rel="noopener noreferrer" className="cta-primary">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
                  Linux
                </a>
                <a href="https://github.com/rodrigopereiradevelopment/editecc/releases/download/v1.0.0/EditeCC_0.9.14_aarch64.dmg" target="_blank" rel="noopener noreferrer" className="cta-primary">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
                  macOS
                </a>
              </div>
              <div style={{ textAlign: "center", marginBottom: "24px" }}>
                <a href="https://github.com/rodrigopereiradevelopment/editecc/releases/tag/v1.0.0" target="_blank" rel="noopener noreferrer" style={{ color: "var(--lp-muted)", fontSize: "13px", textDecoration: "underline" }}>
